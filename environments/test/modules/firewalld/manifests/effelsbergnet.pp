class firewalld::effelsbergnet {
  
  include firewalld::iperf
  include firewalld::dcache
  
  # define a zone
  firewalld::zone { 'effelsbergnet':
    short       => 'effelsbergnet',
    description => 'Rules for the external connections from effelsbergnet.',
    interfaces  => [$my_eth_private_eff],
    rich_rules  => [
